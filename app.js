...
var SCEN = {
  worker: [
    { id:'w1',
      label:{en:'I was fired and the EDD denied my unemployment', es:'Me despidieron y el EDD me negó el desempleo'},
      forum:'EDD · CUIAB',
      ...
      clock:{en:'30 days from the mailing date on the Notice of Determination (Unemp. Ins. Code section 1328).', es:'30 días desde la fecha de envío del Aviso de Determinación (Código de Seguro de Desempleo, artículo 1328).'},
      win:{days:30},
    ...
    { id:'w2',
      label:{en:'I quit my job and the EDD denied me', es:'Renuncié a mi trabajo y el EDD me negó'},
      forum:'EDD · CUIAB',
    ...
    { id:'w5',
      ...
      clock:{en:'30 days from the mailing date on the judge\u2019s decision (Unemp. Ins. Code section 1336).', es:'30 días desde la fecha de envío de la decisión del juez (Código de Seguro de Desempleo, artículo 1336).'},
      win:{days:30},
    ...
    { id:'w6',
      ...
      clock:{en:'3 years from the last discriminatory act to file with the CRD (Gov. Code section 12960). After a right-to-sue notice: 1 year to file suit.', es:'3 años desde el último acto discriminatorio para presentar ante el CRD (Código de Gobierno, artículo 12960). Después del aviso de derecho a demandar: 1 año para demandar.'},
      win:{years:3},
  ...
  employer: [
    ...
    { id:'e3',
      label:{en:'The EDD is auditing my payroll or sent a Notice of Assessment', es:'El EDD está auditando mi nómina o me mandó un Aviso de Liquidación'},
      forum:'EDD · CUIAB',
      ...
      clock:{en:'30 days from the Notice of Assessment to petition for reassessment (Unemp. Ins. Code section 1222).', es:'30 días desde el Aviso de Liquidación para pedir la reevaluación (Código de Seguro de Desempleo, artículo 1222).'},
      win:{days:30},
...
var TSTR = {
  en:{ pathH:'Your path', clockH:'Your clock', gatherH:'Gather now', dateL:'Date printed on your notice', calc:'Compute my date',
       ...
       cta:'Get a free case review', ctaNote:'Send the notice with the form and we reply within a business day.' },
  es:{ pathH:'Su camino', clockH:'Su reloj', gatherH:'Junte desde ahora', dateL:'Fecha impresa en su aviso', calc:'Calcular mi fecha',
       ...
       cta:'Revisión gratuita de su caso', ctaNote:'Mande el aviso con el formulario y respondemos en un día hábil.' },
};
...
function renderTriage(){
  ...
  html += '</ol>';
  html += '<div class="tri-h">' + t.clockH + '</div><p class="tri-clock">' + s.clock[LANG] + '</p>';
  if (s.win){
  ...
  html += '<div class="tri-cta"><a class="btn il" href="' + withLang('index.html#review', LANG) + '">' + t.cta + '</a><p class="small">' + t.ctaNote + '</p></div>';
